...
import solo.dev.solobackend.member.service.MemberService;
...
public class MemberController {
    ...
    private final String REDIRECT_URI = "http://localhost:9000/login/callback"; // 리다이렉트 URI
    ...
    public String loginCallback(@RequestParam("code") String code, HttpSession session) throws IOException {
        ...
        MemberVO member = memberService.findByKakaoId(kakaoId);
